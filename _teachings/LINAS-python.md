...
schedule:
  - week: 1
    date: Mar 18
    topic: Inputs, Outputs & Arithmetic
    description: Overview of basic Python programming in the Jupyter Notebook environment. 
    materials:
      - name: Notebook
        url: /assets/teaching/LINAS-Python/Week1.ipynb
  - week: 2
    date: Mar 25
    topic: Data Types & Indexing Basics
    description: Introduction to variable types including strings, integers, floats, booleans and lists.
    materials:
      - name: Notebook
        url: 
  - week: 3
    date: Apr 1
    topic: Conditional Logic, Control Flow and Functions
    description: Operating under conditional logic and repeating code with loops and functions.
    materials:
      - name: Notebook
        url: 
  - week: 4
    date: Apr 8
    topic: Debugging and Basic Error Handling
    description: Fixing code, reading errors and troubleshooting.
    materials:
      - name: Notebook
        url: 
  - week: 5
    ...
    description: Dictionaries, Classes and Arrays.
    materials:
      - name: Notebook
        url:
